...
function validate(){
	...
	*/
   var selection = form.selection.value;
   var op = document.getElementById("validation.selection"); 
   ...
   if(selection != "Select one"){
      ...
      op.innertext = "Please enter a different element";
      succeeded = False;
   }
...
<select name="selection" type= "text">
...
<span style="display:none;" id="validation.selection"></span>
